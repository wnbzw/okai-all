...
import static com.zw.okai.model.enums.AppScoreStrategyEnum.AI;
import static com.zw.okai.model.enums.AppScoreStrategyEnum.CUSTOM;
...
public class ScoringStrategyContext {
    ...
    public UserAnswer doScore(List<String> choiceList, App app) throws Exception {
        ...
        AppScoreStrategyEnum appScoringStrategyEnum = AppScoreStrategyEnum.getEnumByValue(app.getScoringStrategy());
