...
import com.zw.okai.model.dto.app.AppAddRequest;
import com.zw.okai.model.dto.app.AppEditRequest;
import com.zw.okai.model.dto.app.AppQueryRequest;
import com.zw.okai.model.dto.app.AppUpdateRequest;
 ...
 * 应用接口
 *
 * @author <a href="https://github.com/wnzbw">程序员zw</a>
...
public class AppController {
    ...
    public BaseResponse<Boolean> reviewApp(@RequestBody ReviewRequest reviewRequest, HttpServletRequest request) {
        ...
        App oldApp = appService.getById(id);
        ThrowUtils.throwIf(oldApp == null, ErrorCode.NOT_FOUND_ERROR);
        //如果两次审核状态相同，则不执行操作,不推荐==号,因为包装类型比较的是地址
        if (oldApp.getReviewStatus().equals(reviewStatus)) {
            return ResultUtils.success(true);
        }
        //ThrowUtils.throwIf(oldApp.getReviewStatus() == 1, ErrorCode.OPERATION_ERROR, "该应用已审核通过");
